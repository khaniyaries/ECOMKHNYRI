    ...
    return(
        <>
            <nav className="h-full w-full md:p-2 lg:p-0 items-center md:border-b flex flex-row">
                ...
                <div className="lg:w-[25%] md:w-[25%] w-[40%] flex justify-end md:justify-center items-center flex-row gap-2">
                    <Image 
                        src="/images/logo.png" 
                        alt="Yarees Logo" 
                        width={40} 
                ...
                <div className="lg:w-[30%] md:w-[40%] hidden md:visible md:flex md:flex-row md:justify-evenly font-poppins">
                    ...
                    <Link href='/' className="md:text-sm lg:text-base">Contact</Link>
                    <Link href='/user/about' className="md:text-sm lg:text-base">About</Link>
                    <Link href='/' className="md:text-sm lg:text-base">Sign Up</Link>
                </div>

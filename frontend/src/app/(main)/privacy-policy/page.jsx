const PrivacyPolicy = () =>{
    return(
        ...
        <header className="border-b w-full">
            <h1 className="md:px-20 lg:px-40 px-10 py-4 font-poppins font-bold text-xl">Privacy Policy for YAREES</h1>
        </header>
        <div className="md:px-20 lg:px-40 px-10 py-14 flex flex-col gap-10 justify-center">
            <section className="space-y-8">
                <h1 className="font-poppins font-bold text-3xl">Privacy Policy</h1>
            ...
            <section className="space-y-8">
                <h1 className="font-poppins font-bold text-3xl">Interpretation and Definitions</h1>
                ...
                <ul className="list-disc pl-12 space-y-6">
                    <li>
                        <span className="font-bold">Account</span> means a unique account created for You to access our Service 
                        or parts of our Service.
                    </li>
                    <li>
                        <span className="font-bold">Affiliate</span> means an entity that controls, is controlled by or is under common 
                    ...
                    <li>
                        <span className="font-bold">Company</span> (referred to as either "the Company", "We", "Us" or "Our" 
                        in this Agreement) refers to YAREES, Srinagar,Jammu & Kashmir.
                    </li>
                    <li>
                    ...
                    <li>
                        <span className="font-bold">Country</span> refers to: Jammu and Kashmir, India
                    </li>
                    <li>
                        <span className="font-bold">Device</span> means any device that can access the Service such as a computer, 
                        a cellphone or a digital tablet.
                    </li>
                    <li>
                        <span className="font-bold">Personal Data</span> is any information that relates to an identified 
                    ...
                    <li>
                        <span className="font-bold">Service Provider </span> means any natural or legal person who processes the data 
                    ...
                    <li>
                        <span className="font-bold">Third-party Social Media Service</span> refers to any website or any social network 
                    ...
                    <li>
                        <span className="font-bold">Website</span> refers to YAREES, accessible from <a className="underline text-blue-800" href="https://yarees.in">https://yarees.in</a>
                    </li>
                    <li>
                        <span className="font-bold">You</span> means the individual accessing or using the Service, or the company, 
                        or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
                    </li>
                </ul>
            </section>
            <section className="space-y-8">
                <h1 className="font-poppins font-bold text-3xl">Collecting and Using Your Personal Data</h1>
                ...
                <h3 className="text-xl font-bold">Information from Third-Party Social Media Services</h3>
                ...
                <ul className="list-disc pl-12 space-y-6">
                    <li>
                        <span className="font-bold">Cookies or Browser Cookies.</span> A cookie is a small file placed on Your Device. 
                        You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You 
                        do not accept Cookies, You may not be able to use some parts of our Service. Unless you have adjusted Your browser 
                ...
                <ul className="list-disc pl-12 space-y-6">
                    <li className="space-y-4">
                        <h3 className="font-bold">Cookies Policy / Notice Acceptance Cookies</h3>
                ...
                <ul className="list-disc pl-12 space-y-6">
                    <li className="space-y-4">
                        <h3 className="font-bold">Functionality Cookies</h3>
                        <p>Type: Persistent Cookies</p>
                        <p>Administered by: Us</p>
                        <p>
                ...
                <ul className="list-disc pl-12 space-y-6">
                    ...
                    <li>
                        <span className="font-bold">With other users:</span> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside. If You interact with other users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social Media Service may see Your name, profile, pictures and description of Your activity. Similarly, other users will be able to view descriptions of Your activity, communicate with You and view Your profile.
                    </li>
                    <li>
            ...
            <section className="space-y-8">
                <h1 className="font-poppins font-bold text-3xl">Children's Privacy</h1>
                <p>
            ...
            <section className="space-y-8">
                <h1 className="font-poppins font-bold text-3xl">Links to Other Websites</h1>
                <p>
            ...
            <section className="space-y-8">
                <h1 className="font-poppins font-bold text-3xl">Changes to this Privacy Policy</h1>
            ...
            <section className="space-y-8">
                <h1 className="font-poppins font-bold text-3xl">Contact Us</h1>
                <p>If you have any questions about this Privacy Policy, You can contact us:</p>
                <ul className="list-disc pl-12 space-y-6">
                    <li>By email: support@yarees.in</li>
                    <li>By visiting this page on our website: <a className="underline text-blue-800" href="https://yarees.in">https://yarees.in</a></li>
                </ul>
            </section>
